# Verbose mode
Mostly for debugging... but if you are curious on what's going under the hood, it may be interesting to try.

If you run `rosservice_echo.py` with `-v` as with the first example in the [README](README.md) you'll get something like:
